...
class SpaceScrollWrapper extends React.Component {
  componentDidMount() {
    ...
    this.bgWrapper.appendChild(this.renderer.view);
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.scrollToSection !== false) this.scrollToSection(nextProps.scrollToSection);
  }
  ...
  scrollToSection(targetSection) {
    ...
    const relativeTargetPos = (targetSection === 0) ? scrollSections[targetSection].pos : scrollSections[targetSection].pos + this.shiftLen;
    ...
    this.props.resetScrollToSection();
  }
